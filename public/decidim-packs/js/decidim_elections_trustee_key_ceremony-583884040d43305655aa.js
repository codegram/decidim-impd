...
/***/ "../../.asdf/installs/ruby/2.7.2/lib/ruby/gems/2.7.0/bundler/gems/decidim-d3b88afe90e5/decidim-elections/app/packs/entrypoints/decidim_elections_trustee_key_ceremony.js":
/*!*******************************************************************************************************************************************************************************!*\
  !*** ../../.asdf/installs/ruby/2.7.2/lib/ruby/gems/2.7.0/bundler/gems/decidim-d3b88afe90e5/decidim-elections/app/packs/entrypoints/decidim_elections_trustee_key_ceremony.js ***!
  \*******************************************************************************************************************************************************************************/
...
/* harmony import */ var src_decidim_elections_trustee_key_ceremony__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! src/decidim/elections/trustee/key_ceremony */ "../../.asdf/installs/ruby/2.7.2/lib/ruby/gems/2.7.0/bundler/gems/decidim-d3b88afe90e5/decidim-elections/app/packs/src/decidim/elections/trustee/key_ceremony.js");


/***/ }),

/***/ "../../.asdf/installs/ruby/2.7.2/lib/ruby/gems/2.7.0/bundler/gems/decidim-d3b88afe90e5/decidim-elections/app/packs/src/decidim/elections/trustee/key_ceremony.js":
/*!***********************************************************************************************************************************************************************!*\
  !*** ../../.asdf/installs/ruby/2.7.2/lib/ruby/gems/2.7.0/bundler/gems/decidim-d3b88afe90e5/decidim-elections/app/packs/src/decidim/elections/trustee/key_ceremony.js ***!
  \***********************************************************************************************************************************************************************/
/***/ (function(__unused_webpack_module, __webpack_exports__, __webpack_require__) {
...
$(function () {
  // UI Elements
  var $keyCeremony = $(".trustee-step");
  var $startButton = $keyCeremony.find(".start");
  var $backupModal = $("#show-backup-modal");
  var $backupButton = $backupModal.find(".download-election-keys");
  var $backButton = $keyCeremony.find(".back");
  ...
  var electionUniqueId = "".concat($keyCeremony.data("authoritySlug"), ".").concat($keyCeremony.data("electionId"));
  var authorityPublicKeyJSON = JSON.stringify($keyCeremony.data("authorityPublicKey"));
  var schemeName = $keyCeremony.data("schemeName");
  var trusteeContext = {
    uniqueId: $keyCeremony.data("trusteeSlug"),
    publicKeyJSON: JSON.stringify($keyCeremony.data("trusteePublicKey"))
  };
  var currentStep = null;
  var trusteeIdentificationKeys = new _codegram_decidim_bulletin_board__WEBPACK_IMPORTED_MODULE_1__.IdentificationKeys(trusteeContext.uniqueId, trusteeContext.publicKeyJSON); // Use the correct trustee wrapper adapter
  ...
  var component = new _codegram_decidim_bulletin_board__WEBPACK_IMPORTED_MODULE_1__.KeyCeremonyComponent({
  ...
  trusteeIdentificationKeys.present( /*#__PURE__*/function () {
    var _ref = _asyncToGenerator( /*#__PURE__*/_babel_runtime_regenerator__WEBPACK_IMPORTED_MODULE_0___default().mark(function _callee(exists) {
          ...
          switch (_context.prev = _context.next) {
            ...
            case 3:
              ...
              return component.bindEvents({
                ...
                onBindBackupButton: function onBindBackupButton(backupData, backupFilename, onEventTriggered) {
                  $backupButton.attr("href", "data:text/plain;charset=utf-8,".concat(backupData));
                ...
                onBackupNeeded: function onBackupNeeded() {
                  $backupModal.foundation("open");
                },
                onBackupStarted: function onBackupStarted() {
...
/******/ })()
;
//# sourceMappingURL=decidim_elections_trustee_key_ceremony-583884040d43305655aa.js.map